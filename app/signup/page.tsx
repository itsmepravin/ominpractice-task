      ...
      <div className="flex flex-col p-6">
        ...
        <div className="flex flex-row">
          ...
          <div className="container mx-auto bg-white flex flex-col mt-24 text-gray-700">
            <div className="w-10/12 sm:w-8/12 md:w-6/12 lg:w-4/12 xl:w-4/12 mb-16">
            ...
            <div className="w-3/4 flex flex-col gap-4">
              ...
              <div className="flex items-center">
                ...
                <button
                  className="ml-auto w-1/4 bg-red-400 text-white p-2 rounded font-medium shadow-lg hover:text-gray-700"
                  type="submit"
                >
                  Signup
                </button>
